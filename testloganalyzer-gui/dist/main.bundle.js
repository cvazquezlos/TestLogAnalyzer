        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        this.code = 1;
                        return [4 /*yield*/, this.elasticsearchService.postProject(this.project)];
                    case 1:
                        _b.sent();
                        return [4 /*yield*/, this.elasticsearchService.postFileProject(this.project.name)];
                    case 2:
                        _b.sent();
                        _a = this.currentTab;
                        switch (_a) {
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, this.elasticsearchService.postFileByUpload(files)];
                    case 4:
                        _b.sent();
                        return [3 /*break*/, 6];
                    case 5:
                        this.elasticsearchService.postFileByUrl(this.urlTxt).subscribe(function (a) {
                            _this.code = 2;
                            _this.elasticsearchService.postFileByUrl(_this.urlXml).subscribe(function (b) { return b; }, function (error) { return console.log(error); });
...
var ReportComparisonComponent = /** @class */ (function () {
    function ReportComparisonComponent(activatedRoute, breadcrumbs, dialog, tableService, elasticsearchService) {
        this.activatedRoute = activatedRoute;
        this.breadcrumbs = breadcrumbs;
        this.dialog = dialog;
    ...
    ReportComparisonComponent.prototype.cleanContent = function (mode) {
        return __awaiter(this, void 0, void 0, function () {
            var auxC, execution, testcases, i, name_1, aux, i, failedMethods, j;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        auxC = [];
                        ...
                        return [4 /*yield*/, this.elasticsearchService.getExecutionByIdAsync((mode === 0) ? (this.test)
                                : (this.selected[0].id + ''))];
                    case 1:
                        execution = _a.sent();
                        testcases = [];
                        for (i = 0; i < execution.testcases.length; i++) {
                            name_1 = execution.testcases[i].name;
                            testcases.push(name_1.substring(0, name_1.indexOf('(')) + ',' + (execution.testcases[i].failureDetail !== null));
                        }
                        for (i = 0; i < auxC.length; i++) {
                            aux = [];
                            failedMethods = [];
                            for (j = 0; j < auxC[i].methods.length; j++) {
    ...
    ReportComparisonComponent.prototype.viewByMethods = function (mode) {
        return __awaiter(this, void 0, void 0, function () {
            var loggers, i, logger, partialLogger, methods, methodsData, j, cleanMethod, _a, _b, _c, _d;
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        this.ready = false;
    ...
    ], ReportComparisonComponent.prototype, "process", void 0);
    ReportComparisonComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2__angular_router__["ActivatedRoute"], __WEBPACK_IMPORTED_MODULE_3_ng2_breadcrumbs__["BreadcrumbsService"], __WEBPACK_IMPORTED_MODULE_1__angular_material__["h" /* MatDialog */],
            __WEBPACK_IMPORTED_MODULE_5__service_table_service__["a" /* TableService */], __WEBPACK_IMPORTED_MODULE_4__service_elasticsearch_service__["a" /* ElasticsearchService */]])
...
var ElasticsearchService = /** @class */ (function () {
    function ElasticsearchService(http) {
        ...
        this.baseAPIFilesUrl = this.baseAPIUrl + 'api/files';
    ...
    ElasticsearchService.prototype.deleteExecutionById = function (id) {
        return this.http.delete(this.baseAPIExecutionsUrl + '/id/' + id).map(function (response) { return response; }, function (error) { return error; });
    };
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        composedUrl = this.baseAPILogsUrl + '/test/' + test + '?project=' + project + '&classes=' + classes;
    ...
    ElasticsearchService.prototype.getProjectByName = function (name) {
        return this.http.get(this.baseAPIProjectsUrl + '/name/' + name).map(function (response) { return response; }, function (error) { return error; });
    };
    ElasticsearchService.prototype.postProject = function (project) {
        return __awaiter(this, void 0, void 0, function () {
            var headers, object, response;
            return __generator(this, function (_a) {
                try {
                    ...
                    response = this.http.post(this.baseAPIProjectsUrl, object, { headers: headers }).toPromise();
                    return [2 /*return*/, response];
                }
                catch (error) {
                    console.log(error);
    ...
    ElasticsearchService.prototype.deleteProjectById = function (id) {
        return this.http.delete(this.baseAPIProjectsUrl + '/id/' + id).map(function (response) { return response; }, function (error) { return error; });
    };
    ElasticsearchService.prototype.postFileByUpload = function (files) {
        return __awaiter(this, void 0, void 0, function () {
            var body, i, headers, response, error_5;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        ...
                        return [4 /*yield*/, this.http.post(this.baseAPIFilesUrl + '/file', body, { headers: headers }).toPromise()];
                    case 1:
                        response = _a.sent();
                        return [2 /*return*/, response];
                    case 2:
    ...
    ElasticsearchService.prototype.postFileByUrl = function (url) {
        var body = JSON.stringify(url);
        var headers = new __WEBPACK_IMPORTED_MODULE_0__angular_common_http__["c" /* HttpHeaders */]();
        headers.append('Content-Type', 'text/plain');
        return this.http.post(this.baseAPIFilesUrl + '/url', body, { headers: headers }).map(function (response) { return response; }, function (error) { return error; });
    };
    ElasticsearchService.prototype.postFileProject = function (project) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                try {
                    ...
                    headers = new __WEBPACK_IMPORTED_MODULE_0__angular_common_http__["c" /* HttpHeaders */]();
                    headers.append('Content-Type', 'text/plain');
                    response = this.http.post(this.baseAPIFilesUrl, body, { headers: headers }).toPromise();
                    return [2 /*return*/, response];
                }
                catch (error) {
                    console.log(error);
...
var TableService = /** @class */ (function () {
    ...
    TableService.prototype.solveResultErrors = function () {
        this.oldData = '';
        var entry = false, entry2 = false, lastLength = 0, newLength = 0, oldDataC = '';
        for (var i = 0; i < this.results.length; i++) {
            var result = this.results[i];
            var comparator = result.com_p.content;
            if (((comparator.indexOf('<del>') !== -1) && (result.com_p !== undefined)) || (entry2)) {
                newLength = comparator.length;
                var diffPart = comparator.substring(comparator.indexOf('<del>'), comparator.lastIndexOf('</del>') + 6);
                result.com_p.class = 'delC';
                if (((diffPart.length / comparator.length) > 0.75) && (!entry2)) {
                    if (comparator.indexOf('<span>') !== -1) {
                        ...
                        var cleanOldData = this.oldData.replace('<span>', '').replace('</span>', '');
