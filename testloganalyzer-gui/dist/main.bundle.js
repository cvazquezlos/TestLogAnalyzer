...
var ElasticsearchService = /** @class */ (function () {
    ...
    ElasticsearchService.prototype.getProjectByName = function (name) {
        return this.http.get(this.baseAPIProjectsUrl + '/name/' + name).map(function (response) { return response; }, function (error) { return 'No project found with the given name.'; });
    };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        composedUrl = this.baseAPIFilesUrl + '/' + project;
