...
import elastest.loganalyzer.es.client.DiffMatchPatch.LinesToCharsResult;
import elastest.loganalyzer.es.client.DiffMatchPatch.Patch;
...
public class DiffMatchPatchTest {
	...
	public static void testDiffPrettyHtml() {
		...
		LinkedList<Diff> diffs = diffList(new Diff(EQUAL, "a\n"), new Diff(DELETE, "<B>b</B>"),
				new Diff(INSERT, "c&d"));
		assertNotEquals("diff_prettyHtml:",
